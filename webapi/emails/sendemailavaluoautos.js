...
let sendemail = async function datos(ciudad,marca,modelo,tipo,cantidad,correo,telefono,nombre,primerapellido,segundoapellido,fecnac,replayto){
    ...
    body = body +'</tbody>';
    body = body +'<tr> ';
    body = body +'<td colspan="3" style="text-align:right;padding:7px 0 5px 0;vertical-align:top;font-size:13px;line-height:18px;font-family:Arial,sans-serif"> <h2 style="font-size:20px;line-height:24px;margin:0;padding:0;font-weight:normal;color:rgb(0,0,0)!important">Solicitud de Préstamo Auto</h2>';
    body = body +'</td>';
    body = body +'</tr>';
    body = body +'<tr> ';
    body = body +'<td style="vertical-align:top;font-size:13px;line-height:18px;font-family:Arial,sans-serif"> ';
    ...
    body = body +'<tbody>';
    body = body +'<tr> ';
    body = body +'<td style="vertical-align:top;font-size:13px;line-height:18px;font-family:Arial,sans-serif"> <h3 style="font-size:18px;color:rgb(204,102,0);margin:15px 0 0 0;font-weight:normal">Hola, estamos revisando tu información y pronto nos pondremos en contacto.<br>Ésta es la información que proporcionaste:</h3> <p style="margin:1px 0 0 0;font:13px/18px Arial,sans-serif">';
    body = body +'</tr>';
    body = body +'<tr> ';
    ...
    body = body +'Primer apellido: '+primerapellido+'<br>';
    body = body +'Segundo apellido: '+segundoapellido+'<br>';
    body = body +'Fecha de nacimiento: '+fecnac+'<br>';
    body = body +'Ciudad: '+ciudad+'<br>';
    body = body +'Marca: '+marca+'<br>';
    body = body +'Modelo : '+modelo+'<br>';
    body = body +'Tipo : '+tipo+'<br>';
    body = body +'Cantidad Solicitada : '+cantidad+'<br>';
    body = body +'Teléfono : '+telefono+'<br>';
    body = body +'Email : '+correo+'<br>';
    ...
    let email ={ 
        ...
        subject:" Solicitud de Préstamo Auto - Maxilana",
        html: body,// cuerpo,
        replyTo :replayto
    };
